...
| `/tools` | `SiegeTower.Client` / `ToolsScreen` | Tool collection and GitHub access-token generation form. |
...
- Use `/tools` for client-side utility screens, including GitHub access-token generation.
