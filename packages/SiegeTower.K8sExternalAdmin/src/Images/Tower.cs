...
public static class Tower
{
	...
	server {
	    ...
	    location /api {
	        ...
	        return 200 "<!doctype html><html><body><h1>tower connected</h1><p>method: $request_method</p><p>local route: $uri</p><p>request URI: $request_uri</p><p>args: $args</p></body></html>";
	    }
	}
	""";
}
